...
import com.example.zhumuapplication.view.ImportProgressDialog;
...
public class FaceManageActivity extends BaseActivity {
    ...
    ImportProgressDialog progressDialog = null;
    ...
    private void doRegister() {
        ...
        if (!dir.exists()) {
            ZhumuToastUtil.showToast(getString(R.string.batch_process_path_is_not_exists, REGISTER_DIR));
            return;
        }
        if (!dir.isDirectory()) {
            ZhumuToastUtil.showToast(getString(R.string.batch_process_path_is_not_dir, REGISTER_DIR));
            return;
        }
    ...
    public void clearFaces(View view) {
        ...
        if (faceNum == 0) {
            ZhumuToastUtil.showToast(getString(R.string.batch_process_no_face_need_to_delete));
        } else {
